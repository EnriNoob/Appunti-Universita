Una **texture** è un’immagine 2D che viene applicata a una superficie 3D per aggiungere dettagli visivi come colori, pattern, e materiali senza dover modellare ogni piccolo dettaglio.
